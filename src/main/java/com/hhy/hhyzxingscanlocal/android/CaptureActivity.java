package com.hhy.hhyzxingscanlocal.android;
...
import com.hhy.hhyzxingscanlocal.bean.ZxingConfig;
import com.hhy.hhyzxingscanlocal.R;
import com.hhy.hhyzxingscanlocal.camera.CameraManager;
import com.hhy.hhyzxingscanlocal.common.Constant;
import com.hhy.hhyzxingscanlocal.decode.DecodeImgCallback;
import com.hhy.hhyzxingscanlocal.decode.DecodeImgThread;
import com.hhy.hhyzxingscanlocal.decode.ImageUtil;
import com.hhy.hhyzxingscanlocal.view.ViewfinderView;
        ...
        if (requestCode == 777 && resultCode == RESULT_OK) {
            ...
            try {
                ...
                try {
                    ...
                    this.setResult(666,intent);
                    Log.i ("HHY", result.getText ());
                    finish();
                } catch (NotFoundException e) {
                    //Log.i(TAG, "onActivityResult: notFind");
                    Toast.makeText (this, "扫描相册失败，请重新选择", Toast.LENGTH_SHORT).show ();
                    e.printStackTrace();
